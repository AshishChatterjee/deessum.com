                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Locality List</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach($localities->result() as $locality){ ?>
                                    
                                            <tr>
                                                <td><?php echo $locality->id; ?></td>
                                                <td><?php echo $locality->city_name; ?></td>
                                                <td><?php echo $locality->locality; ?></td>
                                                <td><?php echo $locality->c_dt; ?></td>
                                                
                                                <td class="text-right">
                                                    <a href="<?php echo base_url('master/locality/'.$locality->id."/EDiT") ?>" class="btn btn-info btn-flat">Edit</a>
                                                    <a href="<?php echo $locality->id; ?>" onclick="return deleteLocality(this)" class="btn btn-danger btn-flat ">Delete</a>
                                                </td>
                                            </tr>
                                    <?php } ?>
                                </tbody>
