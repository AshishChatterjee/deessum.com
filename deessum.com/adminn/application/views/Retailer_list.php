                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach($retailers->result() as $retailer){ ?>
                                    
                                            <tr>
                                                <td><?php echo $retailer->id; ?></td>
                                                <td><?php echo $retailer->name; ?></td>
                                                <td><?php echo $retailer->mobile; ?></td>
                                                <td><?php echo $retailer->email; ?></td>
                                                <td><?php echo $retailer->address; ?></td>
                                                <td class="text-right">
                                                    <a href="<?php echo base_url('retailer/retailer/'.$retailer->id."/EDiT") ?>" class="btn btn-info btn-flat">Edit</a>
                                                    <a href="<?php echo $retailer->id; ?>" onclick="return deleteRetailer(this)" class="btn btn-danger btn-flat ">Delete</a>
                                                </td>
                                            </tr>
                                    <?php } ?>
                                </tbody>
