                                ...
                                <tbody>
                                    <?php foreach($categories->result() as $category){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $category->c_dt; ?></td>
                                            
                                            <td class="text-right">
                                                <a href="<?php echo base_url('master/category/'.$category->id."/EDiT") ?>" class="btn btn-info btn-flat">Edit</a>
                                                <a href="<?php echo $category->id; ?>" onclick="return deleteCategory(this)" class="btn btn-danger btn-flat ">Delete</a>
                                            </td>
                                        </tr>
