...
<head>
    ...
    <title>Second Round Candidate list - <?php echo $project_head; ?></title>
    <!--favicon-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-sm-right">
                                        <a href="<?php echo base_url('candidate/assignGroupRIIC/'); ?>" >
                                            <button class="btn-outline-success border-0 shadow-light m-1"> <span class="moon-security-on"></span> Assign Grouping</button>
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body">
