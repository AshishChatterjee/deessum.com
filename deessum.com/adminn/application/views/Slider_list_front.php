                                    ...
                                    <tbody>
                                        <?php foreach($sliders->result() as $slider){ ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img style="width:100px;" src="<?php echo base_url("front_image/".$slider->image); ?>"/></td>
                                                    

                                                    <td class="text-right">
                                                        <a href="<?php echo $slider->id; ?>" onclick="return deleteSlider(this)" class="btn btn-info btn-flat">Delete</a>
                                                        <a href="<?php echo base_url('front/slider/'.$slider->id."/EDiT") ?>" class="btn btn-danger btn-flat ">Edit</a>
                                                    </td>
                                                </tr>
                                        <?php } ?>
                                    </tbody>
