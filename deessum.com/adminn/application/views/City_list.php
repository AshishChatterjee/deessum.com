                                ...
                                <tbody>
                                    <?php foreach($cities->result() as $city){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $city->c_dt; ?></td>

                                                <td class="text-right">
                                                    <a href="<?php echo base_url('master/city/'.$city->id."/EDiT") ?>" class="btn btn-info btn-flat">Edit</a>
                                                    <a href="<?php echo $city->id; ?>" onclick="return deleteCity(this)" class="btn btn-danger btn-flat ">Delete</a>
                                                </td>
                                            </tr>
                                    <?php } ?>
                                </tbody>
