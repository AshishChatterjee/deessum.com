                                    ...
                                    <tbody>
                                        <?php foreach($medias->result() as $media){ ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="<?php echo $media->id; ?>" onclick="return deleteMedia(this)" class="btn btn-info btn-flat">Delete</a>
                                                        <a href="<?php echo base_url('front/socialMedia/'.$media->id."/EDiT") ?>" class="btn btn-danger btn-flat ">Edit</a>
                                                    </td>
                                                </tr>
                                        <?php } ?>
                                    </tbody>
        ...
        function deleteMedia(r){
            notie.confirm('Are you sure want to delete ...', 'Yes', 'Cancel', function() {
                ...
                $.ajax({
                    ...
                    data:{"id":id,"table":"social_media_links"},
