...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="<?php echo base_url()?>assets/printmaster/js/fabric.js"></script>
	
	
    <!-- Le styles -->
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/printmaster/css/jquery.miniColors.css" />
    <link href="<?php echo base_url()?>assets/printmaster/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url()?>assets/printmaster/css/bootstrap-responsive.min.css" rel="stylesheet">
...
<script src="<?php echo base_url()?>assets/printmaster/js/canvas2image.js"></script>
  </head>
  ...
  <!-- Navbar
    ...
    <div class="container">
		<section id="typography">
		  <br>
		 <center><h2>Customize T-Shirt</h2><center>
		    ...
		    <div class="span3">
		    	...
		    	<div class="tabbable"> <!-- Only required for left/right tabs -->
				  <ul class="nav nav-tabs">
				    ...
				    <li><a href="#tab2" data-toggle="tab">Add Text</a></li>
				  </ul>
...
<!--						      <p>-->
						      	<select id="tshirttype">                        
				                    <option value="<?php echo base_url()?>assets/printmaster/img/crew_front.png" selected="selected">Short Sleeve Shirts</option>
				                    <option value="<?php echo base_url()?>assets/printmaster/img/mens_longsleeve_front.png">Long Sleeve Shirts</option>                                        
				                    <option value="<?php echo base_url()?>assets/printmaster/img/mens_hoodie_front.png">Hoodies</option>                    
				                    <option value="<?php echo base_url()?>assets/printmaster/img/mens_tank_front.png">Tank tops</option>
								</select>	
<!--						      </p>-->								
					      </div>
					      <div class="well">
				    ...
				    <div class="tab-pane" id="tab2">
				    	<div class="well">
							...
							<div id="avatarlist">
								<img style="cursor:pointer;" class="img-polaroid" src="<?php echo base_url()?>assets/printmaster/img/invisibleman.jpg">
		    ...
		    <div class="span6">		    
		    		<div align="center" style="min-height: 32px;">
		    			<div class="clearfix">
							<div class="btn-group inline pull-left" id="texteditor" style="display:none">						  
							    ...
							    <button id="text-bold" class="btn" data-original-title="Bold"><img src="<?php echo base_url()?>assets/printmaster/img/font_bold.png" height="" width=""></button>
							    <button id="text-italic" class="btn" data-original-title="Italic"><img src="<?php echo base_url()?>assets/printmaster/img/font_italic.png" height="" width=""></button>
							    <button id="text-strike" class="btn" title="Strike" style=""><img src="<?php echo base_url()?>assets/printmaster/img/font_strikethrough.png" height="" width=""></button>
							 	<button id="text-underline" class="btn" title="Underline" style=""><img src="<?php echo base_url()?>assets/printmaster/img/font_underline.png"></button>
                ...
                <button id="flipback" type="button" class="btn" title="Rotate View"><i class="icon-retweet" style="height:19px;float:left;"></i></button>
					<div id="shirtDiv" class="page" style="width: 520px; height: 620px; position: relative; background-color: rgb(255, 255, 255);">
						<img name="tshirtview" id="tshirtFacing" src="<?php echo base_url()?>assets/printmaster/img/crew_front.png">
...
<!--					</div>						-->
			      ...
			      <p>
			      	<table class="table">
			      		<tr>
			      			...
			      			<td align="right"><input min="0" style="width: 30px;" value="1" type="number"></td>
			      		</tr>
			      		<tr>
			      			<td><input type="checkbox">M</td>
			      			<td align="right"><input min="0" style="width: 30px;" placeholder="1" type="number"></td>
			      		</tr>
			      		<tr>
			      			<td><input type="checkbox">L</td>
			      			<td align="right"><input min="0" style="width: 30px;"  placeholder="1" type="number"></td>
			      		</tr>
			      		<tr>
			      			<td><input type="checkbox">XL</td>
			      			<td align="right"><input min="0" style="width: 30px;"  placeholder="1" type="number"></td>
			      		</tr>
                        <tr>
			      			<td><input type="checkbox">XXL</td>
			      			<td align="right"><input min="0" style="width: 30px;"  placeholder="1" type="number"></td>
			      		</tr>
			      	</table>			
			      </p>
				 	<a class="btn btn-large btn-block btn-primary" href="javascript:void(0)" onclick="html2canvas()"><i class="fa fa-cart">Save Image</i></a>
                    ...
                    <a href="<?php echo base_url("product/addtocart/".$prod->id); ?>">
                        <button class="btn btn-large btn-block btn-primary" name="addToTheBag" id="addToTheBag"><i class="fa fa-shopping-cart"></i> Add To Cart</button>
					</a>  
			...
			<hr>
			<div id="img-out" style="width:300px;height:500px;"></div>
			<div id="imgCapture" style="width:300px;height:500px;"></div>
		  <br />
...
<!-- Footer ================================================== -->
   ...
   $("#tshirttype").change(function(){
    ...
    <script>
        ...
        $('#flipback').click(
		   function() {	
               if (valueSelect === "<?php echo base_url()?>assets/printmaster/img/crew_front.png") {
                   if ($(this).attr("data-original-title") == "Show Back View") {
			   		$(this).attr('data-original-title', 'Show Front View');			        		       
			        $("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/crew_back.png");			        
			    	...
			    	$("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/crew_front.png");			    	
               ...
               else if (valueSelect === "<?php echo base_url()?>assets/printmaster/img/mens_longsleeve_front.png") {
                  if ($(this).attr("data-original-title") == "Show Back View") {
			   		$(this).attr('data-original-title', 'Show Front View');			        		       
			        $("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/mens_longsleeve_back.png");			        
			        a = JSON.stringify(canvas);
			        canvas.clear();
			        try
			        {
			    	...
			    	$(this).attr('data-original-title', 'Show Back View');			    				    	
			    	$("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/mens_longsleeve_front.png");			    	
			    	b = JSON.stringify(canvas);
			    	canvas.clear();
			    	try
			        {
               ...
               else if (valueSelect === "<?php echo base_url()?>assets/printmaster/img/mens_tank_front.png") {
                  if ($(this).attr("data-original-title") == "Show Back View") {
			   		$(this).attr('data-original-title', 'Show Front View');			        		       
			        $("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/mens_tank_back.png");			        
			        a = JSON.stringify(canvas);
			        canvas.clear();
			        try
			        {
			    	...
			    	$(this).attr('data-original-title', 'Show Back View');			    				    	
			    	$("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/mens_tank_front.png");			    	
			    	b = JSON.stringify(canvas);
			    	canvas.clear();
			    	try
			        {
               ...
               else if (valueSelect === "<?php echo base_url()?>assets/printmaster/img/mens_hoodie_front.png") {
                  if ($(this).attr("data-original-title") == "Show Back View") {
			   		$(this).attr('data-original-title', 'Show Front View');			        		       
			        $("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/mens_hoodie_back.png");			        
			        a = JSON.stringify(canvas);
			        canvas.clear();
			        try
			        {
			    	...
			    	$(this).attr('data-original-title', 'Show Back View');			    				    	
			    	$("#tshirtFacing").attr("src","<?php echo base_url()?>assets/printmaster/img/mens_hoodie_front.png");			    	
			    	b = JSON.stringify(canvas);
			    	canvas.clear();
			    	try
			        {
    ...
    <script src="<?php echo base_url()?>assets/printmaster/js/bootstrap.min.js"></script>  
<script type="text/javascript" src="<?php echo base_url()?>assets/printmaster/js/tshirtEditor.js"></script>
	<script type="text/javascript" src="<?php echo base_url()?>assets/printmaster/js/jquery.miniColors.min.js"></script>
    <script type="text/javascript">
