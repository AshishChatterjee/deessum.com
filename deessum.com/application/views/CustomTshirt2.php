...
<html lang="en">
  <head>
    ...
    <title>deessum.com</title>
    <meta charset="UTF-8">
    <meta name="description" content=" deessum.com">
    <meta name="keywords" content="deessum, eCommerce, creative, html">
  ...
  <!-- Navbar
    ...
    <div class="container">
		 ...
		 <br>
            <center><h2 style="align:center;">Customize T-Shirt</h1></center>
		    ...
		    <div class="span3">
		    	...
		    	<div class="tabbable"> <!-- Only required for left/right tabs -->
				  <ul class="nav nav-tabs">
				  	<li class="nav-item active"><a href="#tab1" data-toggle="tab">T-Shirt Options</a></li>				    
                      &nbsp;&nbsp; | &nbsp;&nbsp;
                    <li class="nav-item"><a href="#tab2" data-toggle="tab">Add Text</a></li>
				  </ul>
				    ...
				    <div class="tab-pane" id="tab2">
				    	<div id="box3">
				    		<div class="input-append">
							  <input class="span2" id="text-string" type="text" placeholder="add text here..."><button id="add-text" class="btn-primary"" title="Add text">Add<i class="icon-share-alt"></i></button>
							  <hr>
							</div>
							<div id="avatarlist">
		    		...
		    		<div>
		    			<div class="clearfix">
							...
							<div class="pull-right" align="" id="imageeditor">
							  <div class="btn-group">										      
							      <button class="btn fa fa-address-card-o" id="bring-to-front" title="Bring to Front"><i class="icon-fast-backward rotate" style="height:19px;"></i></button>
							      <button class="btn fa fa-arrows" id="send-to-back" title="Send to Back"><i class="icon-fast-forward rotate" style="height:19px;"></i></button>
							      <button id="flip" type="button" class="btn fa fa-beer" title="Show Back View"><i class="icon-retweet" style="height:19px;"></i></button>
							      <button id="remove-selected" class="btn fa fa-trash" title="Delete selected item"><i class="icon-trash" style="height:19px;"></i></button>
							  </div>
							</div>			  
						</div>												
					</div>					  		
				<!--	EDITOR      -->	
                <button id="flipback" type="button" class="btn fa fa-crop" title="Rotate View"><i class="icon-retweet" style="height:19px;"></i></button>
		    ...
		    <div class="span3">
		      <div id="box4">
			      ...
			      <p>
                   ...
                   <a href="<?php echo base_url("product/savecustom/".$prod->id); ?>">
                        <button class="btn btn-large btn-block btn-success" name="saveimg" id="saveimg"><i class="fa fa-shopping-cart"></i>Save Image</button>
                    </a> 
                    <br>
                    <br>
...
<!-- Footer ================================================== -->
   ...
   $("#tshirttype").change(function(){
    ...
    <script>
        ...
        $('#flipback').click(
		   function() {	
               if (valueSelect === "assets/printmaster/img/crew_front.png") {
                   if ($(this).attr("data-original-title") == "Show Back View") {
			   		$(this).attr('data-original-title', 'Show Front View');			        		       
			        $("#tshirtFacing").attr("src","assets/printmaster/img/crew_back.png");			        
			    	...
			    	$("#tshirtFacing").attr("src","assets/printmaster/img/crew_front.png");			    	
